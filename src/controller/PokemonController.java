...
public class PokemonController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (value1 != null) 
		{
			...
			Bulbasaur b=new Bulbasaur("Bulbasaur",001,"Bulbasaur is a Grass/Poison-type Pokémon introduced in Generation I.",
					"POISON","IVYSAUR","64");
		...
		if (value2 != null)
		{
			...
			Charizard c= new Charizard("Charizard",006,"\"Charizard is fit and strong .",
					"FIRE","CHARMELEON","240"); 
		...
		if (value3 != null) 
		{
			...
			// Create the object for Dragonite class and use getters to retrieve the values	
			 ...
			 Dragonite d=new  Dragonite(" Dragonite",149,"Dragonite is capable of flying faster than the speed of sound.", "DRAGON","DRATINI","270"); 
