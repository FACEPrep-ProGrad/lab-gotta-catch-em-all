...
public class PokemonController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (value1 != null) {
			...
			request.setAttribute("message1",bulbasaur.getPokemonName());
		...
		if (value2 != null) {
            ...
            request.setAttribute("message1",msg);
			request.setAttribute("message2",charizard.getPokemonName());
		...
		if (value3 != null) {
            ...
            request.setAttribute("message1",msg);
			request.setAttribute("message3", dragonite.getPokemonName());
		...
		if (value4 != null) {
            ...
            request.setAttribute("message1",msg);
			request.setAttribute("message4",mew.getPokemonName());
...
/*getter*/
            ...
            request.setAttribute("message1",msg);
			request.setAttribute("message5",pikachu.getPokemonName());
